  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.title}>DOCUMENTO DE REASIGNACIÓN DE ACTIVOS</Text>
        <View style={styles.details}>
          <Text>Nombre del Nuevo Responsable: {data.nombre}</Text>
        ...
        <View style={styles.table}>
          <View style={styles.tableRow}>
            ...
            <View style={{...styles.tableColHeader, width: '20%'}}><Text style={styles.tableCell}>Fecha de Ingreso</Text></View>
          </View>
        ...
        <Text style={styles.footer}>
          Este documento certifica que el activo descrito ha sido reasignado al nuevo responsable mencionado arriba, según lo estipulado en los artículos relevantes de las normativas vigentes.
        </Text>
        <Text style={styles.footer}>
          Nota: La reasignación de bienes genera en el servidor público la consiguiente responsabilidad sobre el debido uso, custodia y mantenimiento de los mismos. La pérdida, destrucción o maltrato será atribuida al funcionario público a cargo de los bienes.
        </Text>
        <View style={styles.signRow}>
          <Text style={styles.signSpace}>ACTIVOS FIJOS</Text>
          <Text style={styles.signSpace}>NUEVO RESPONSABLE</Text>
        </View>
      </Page>
    </Document>
  );
